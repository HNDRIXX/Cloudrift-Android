...
public class PcView extends Activity implements AdapterFragmentCallbacks, DateTimeFetcher.DateTimeFetchListener{
    ...
    private void initializeViews() {
        ...
        loaderView = findViewById(R.id.loadView);
        demoView = findViewById(R.id.demoView);

        try {
            if (!isNetworkAvailable()) { showExitAlertDialog(); }

            loaderView.setVisibility(View.VISIBLE);
            DateTimeFetcher dateTimeFetcher = new DateTimeFetcher(this, this);
            dateTimeFetcher.execute();

            databaseReference = FirebaseDatabase.getInstance().getReference().child("Demo");
            databaseReference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    String demoDate = dataSnapshot.child("DemoDate").getValue(String.class);

                    if (demoDate != null && date != null) {
                        if (Integer.valueOf(demoDate.toString()) < Integer.valueOf(date.toString())){
...
//
//        hashMap.put("DemoDate","20240316");
//
//        DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference();
//        DatabaseReference tasksRef = rootRef.child("Demo");
//        tasksRef.setValue(hashMap);
    ...
    private void showExitAlertDialog() {
        ...
        builder.setTitle("Failed to use Cloudrift");
        builder.setMessage("Please open your internet connection to use this app");
...
//            @Override
//            public void onClick(DialogInterface dialogInterface, int i) {
//                // Dismiss the dialog (and keep the app running)
